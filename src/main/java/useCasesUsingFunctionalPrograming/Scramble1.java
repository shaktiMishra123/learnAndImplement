...
public class Scramble1 {
   static BiPredicate<String,String> stringPredicate = (s1, s2) -> s1.length() == s2.length();
  private static BiPredicate<String,String> stringBiPredicate = (s1,s2) -> s1.equalsIgnoreCase(s2);

  private static boolean isScramble(String string1, String string2){
  ...
  public static void main(String[] args) {
    ...
    boolean returnValue = isScramble(scrumbledSExample,sruumbledString);
